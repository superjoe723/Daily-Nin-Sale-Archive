...
def scrape_page(soup):
    ...
    for game in game_elements:
        try:
            ...
            # 날짜 추가
            games.append((name, original_price, sale_price, current_date))
            print(f"추출됨: {name}, 정가: {original_price}, 할인가: {sale_price}, 날짜: {current_date}")
...
def main():
    ...
    try:
        with open(full_path, "w", newline="", encoding="utf-8") as csvfile:
            ...
            writer.writerow(["Game Name", "Original Price", "Sale Price", "Date"])  # 헤더에 Date 추가
